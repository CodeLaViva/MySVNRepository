...
public class Record {
   ...
   /* public Record(@Field_Method_Parameter_Annotation(describe = "编号", type = int.class) int id,
                  @Field_Method_Parameter_Annotation(describe = "姓名", type = String.class)String name){*/
    public Record(@Field_Method_Parameter_Annotation(describe = "编号", type = int.class) int id,  @Field_Method_Parameter_Annotation(describe = "姓名")String name){
        this.id = id;
        this.name = name;
    }
    ...
    public void setName(@Field_Method_Parameter_Annotation(describe = "设置姓名", type = String.class)String name){
        this.name = name;
    }
}
